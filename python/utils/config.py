...
desc_info = {
    ...
    'UnbBEBLID_259_AverageBoxThresholdedWL': Descriptor(name='BEBLID259p20', color='blue'),
    'UnbBEBLID_279_AverageBoxThresholdedWL': Descriptor(name='BEBLID279p20', color='blue'),
